from stationary_scheduler import stationary_schedule
...
def test_valid_schedule():
    ...
    schedulable = stationary_schedule([t2, t4], 5)
    assert schedulable
...
def test_known_partition():
    ...
    schedulable = stationary_schedule([t1, t2, t3, t4, t5], 5)
    assert schedulable
...
def test_00007():
    obj = None
    with open('dump6.pkl', 'rb') as file:
        obj = pickle.load(file)
        obj = pickle.loads(obj)
    stationary_schedule(obj, 8)